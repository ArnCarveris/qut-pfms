...
% Modified by Nicholas Rutherford for the PFMS Project for academic use.
% The file was modifed to reflect the Flamingo UAV utilised by the QUAS
% project.
...
% Airspeed bounds
VaBnd = [40 100]; % m/s */--- [12.9126  40.6411](0.514444444)kts/m/s
% Sideslip angle bounds
BetaBnd = [-0.5 0.5]; % rad
% Angle of attack bounds
AlphaBnd = [-16*pi/180 16*pi/108]; % rad
